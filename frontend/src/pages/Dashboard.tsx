...
const MOCK_LISTINGS = [
  ...
  { id: "m5", title: "Computer Networks â€“ Forouzan (5th Ed.)", description: "Original textbook in excellent condition. All chapters intact, minimal highlighting. Covers OSI, TCP/IP, routing, and more.", price: 320, type: "OFFLINE", category: "Books", subject: "Computer Networks", isFree: false, images: [], seller: { id: "s5", name: "Vikram Nair", reputation: 4.5 }, createdAt: "2026-07-12T14:00:00Z" },
  { id: "m6", title: "Python for Data Science â€“ Full Course Notes", description: "350+ pages of curated Python notes covering NumPy, Pandas, Matplotlib, Scikit-learn and ML fundamentals.", price: 199, type: "ONLINE", category: "Notes", subject: "Data Science", isFree: false, images: [], seller: { id: "s6", name: "Kavya Reddy", reputation: 4.9 }, createdAt: "2026-07-15T10:30:00Z" },
  ...
  { id: "m21", title: "Theory of Computation â€“ GATE 2026 Notes", description: "Topic-wise notes covering FA, PDA, TM, decidability, and complexity. 150+ solved PYQs included.", price: 149, type: "ONLINE", category: "Notes", subject: "TOC", isFree: false, images: [], seller: { id: "s21", name: "Harish Kumar", reputation: 4.9 }, createdAt: "2026-07-22T08:00:00Z" },
  ...
  { id: "m23", title: "Java â€“ Complete Reference by Herbert Schildt", description: "11th edition Java Complete Reference. No highlights, all pages intact. Great for OOP and Java SE prep.", price: 380, type: "OFFLINE", category: "Books", subject: "Java", isFree: false, images: [], seller: { id: "s23", name: "Saurabh Jain", reputation: 4.5 }, createdAt: "2026-07-02T10:00:00Z" },
  { id: "m24", title: "PCB Design Files â€“ Mini Project Collection", description: "Kicad design files for 10 mini PCB projects including power supply, amplifier, and sensor boards. Open-source.", price: 0, type: "ONLINE", category: "Software", subject: "Electronics", isFree: true, images: [], seller: { id: "s24", name: "Meera Pillai", reputation: 4.8 }, createdAt: "2026-07-23T10:00:00Z" },
  { id: "m25", title: "Electromagnetic Field Theory â€“ Hayt & Buck", description: "8th edition EMF Theory book. Lightly used, excellent condition. Covers fields, waves, transmission lines.", price: 290, type: "OFFLINE", category: "Books", subject: "EMF Theory", isFree: false, images: [], seller: { id: "s25", name: "Ankit Verma", reputation: 4.6 }, createdAt: "2026-07-24T09:00:00Z" },
] as const
...
// â”€â”€ Login Prompt Modal â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Purchase Modal â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
type PurchaseItem = {
  id: string
  title: string
  category: string
          ...
          >
            ...
            <div className="relative w-full overflow-hidden" style={{ height: "220px" }}>
              ...
              <div className="absolute bottom-3 left-4">
                ...
                >
                  {item.isFree ? "FREE" : `â‚¹${item.price.toLocaleString("en-IN")}`}
                </span>
              </div>
              {/* Category badge */}
            ...
            <div className="p-6">
              {purchased ? (
                ...
                <>
                  ...
                  >
                    {loading ? (
                      <><Loader2 className="h-4 w-4 animate-spin" /> Sending Requestâ€¦</>
                    ) : item.isFree ? (
            ...
            <>
              <div className="flex items-center gap-3 px-3 py-2.5 rounded-xl mb-1"
                ...
                <div className="min-w-0 flex-1">
                  <p className="text-sm font-semibold truncate" style={{ color: T.text }}>{user?.name ?? "â€”"}</p>
    ...
    <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -12 }} transition={{ duration: 0.22 }} className="p-8 space-y-8 max-w-5xl">
      <div>
        <h2 className="text-2xl font-bold" style={{ color: T.text }}>
          {isAuthenticated ? `Welcome back, ${user?.name?.split(" ")[0] ?? "there"} ðŸ‘‹` : "Welcome to Becho ðŸ‘‹"}
        </h2>
      ...
      {!isAuthenticated ? (
        ...
        <div className="grid grid-cols-3 gap-4">
          {[
            ...
            { label: "Total Earned", value: `â‚¹${stats.earned.toLocaleString("en-IN")}`, icon: TrendingUp, colorStyle: { color: T.text }, bgStyle: { background: T.surface2 } },
            { label: "Reputation", value: stats.reputation > 0 ? `${stats.reputation}/5` : "â€”", icon: Star, colorStyle: { color: "#f59e0b" }, bgStyle: { background: "rgba(245,158,11,0.12)" } },
          ].map((s) => (
        ...
        <div className="grid grid-cols-2 gap-3">
          <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} onClick={() => onUpload("OFFLINE")}
            ...
            <div>
              ...
              <p className="text-xs mt-0.5" style={{ color: T.muted }}>Books, cycles, equipmentâ€¦</p>
            </div>
          ...
          <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} onClick={() => onUpload("ONLINE")}
            ...
            <div>
              ...
              <p className="text-xs mt-0.5" style={{ color: T.muted }}>Notes, PDFs, softwareâ€¦</p>
            </div>
            <ArrowUpRight className="h-4 w-4 ml-auto" style={{ color: T.subtle }} />
          </motion.button>
        </div>
          ...
          {MOCK_LISTINGS.slice(0, 4).map((item) => (
            <div key={item.id} onClick={onViewMarketplace}
              ...
              <span className="text-sm font-bold flex-shrink-0">
                {item.isFree ? <span style={{ color: T.primary }}>Free</span> : <span style={{ color: T.text }}>â‚¹{item.price}</span>}
              </span>
            </div>
          ))}
        </div>
                    ...
                    return (
                      <tr key={l.id} onClick={() => onViewDetail(l.id)}
                        ...
                        <td className="px-4 py-3 text-sm" style={{ color: T.muted }}>
                          {l.isFree ? <span style={{ color: T.primary, fontWeight: 600 }}>Free</span> : `â‚¹${l.price}`}
                        </td>
                        <td className="px-4 py-3">
                          <span className="text-xs font-semibold px-2 py-0.5 rounded-full"
...
// â”€â”€ Marketplace Section (REAL API) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -12 }} className="p-8 max-w-6xl space-y-5" style={{ position: "relative" }}>
      ...
      <div className="relative">
        ...
        <input
          ...
          placeholder="Search listings â€” notes, keyboard, cycle, booksâ€¦"
          value={liveSearch}
      ...
      <AnimatePresence mode="wait">
        {loading ? (
          <motion.div key="loading" initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex flex-col items-center justify-center py-24">
            ...
            <p className="text-sm" style={{ color: T.subtle }}>Loading listingsâ€¦</p>
          </motion.div>
        ) : listings.length === 0 ? (
          <motion.div key="empty" initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex flex-col items-center justify-center py-24 text-center">
            ...
            <p className="text-sm mt-2" style={{ color: T.subtle }}>
              {search ? `No results for "${search}" â€” try different keywords.` : "No listings available right now."}
            </p>
          </motion.div>
        ) : (
          <motion.div
    ...
    <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -12 }} className="p-8 max-w-6xl space-y-6">
      ...
      {wishlisted.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-24 text-center rounded-2xl"
          ...
          <p className="text-sm mt-1" style={{ color: T.subtle }}>Tap the â™¥ on any listing to save it here.</p>
        </div>
      ) : (
              ...
              <motion.div key={item.id}
                ...
                <div className="p-3">
                  <p className="text-xl font-black leading-none" style={{ color: item.isFree ? T.primary : T.text }}>
                    {item.isFree ? "Free" : `â‚¹${Number(item.price).toLocaleString("en-IN")}`}
                  </p>
...
// â”€â”€ Listings Section â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -12 }} className="p-8 space-y-6 max-w-5xl">
      ...
      <div className="relative max-w-sm">
        ...
        <input
          ...
          placeholder="Search your listingsâ€¦" value={search} onChange={(e) => setSearch(e.target.value)}
        />
      </div>
      {loading ? (
                ...
                return (
                  <tr key={l.id} onClick={() => onViewDetail(l.id)}
                    ...
                    <td className="px-4 py-4 text-sm font-semibold">
                      {l.isFree ? <span style={{ color: T.primary }}>Free</span> : <span style={{ color: T.text }}>â‚¹{l.price}</span>}
                    </td>
                    <td className="px-4 py-4">
                      <span className="text-xs font-semibold px-2 py-0.5 rounded-full"
                        style={ls.status === "ACTIVE" ? { background: "rgba(251,146,60,0.12)", color: "#fb923c" } : ls.status === "SOLD" ? { background: T.surface2, color: T.muted } : { background: T.surface2, color: T.subtle }}>
